...
(23, '32 London Bridge St', 'SE1 9SG', 5, 2);
...
INSERT INTO `booking` (`booking_id`, `booking_reference`, `booking_made_timestamp`, `booking_start_date`, `booking_duration_nights`, `number_adults`, `number_children`, `guest_name`, `total_price`, `currency_id`, `customer_id`) VALUES
(2, '1234567891', '2023-10-27 13:41:34', '2024-03-18', 5, 2, 0, 'Catherine McGrade', '476.20', 1, 2),
(3, '1111111111', '2023-10-30 19:10:17', '2024-03-20', 5, 1, 0, 'Josh McCann', '0.01', 1, 3),
(6, '7663663922', '2023-10-30 19:15:07', '2024-05-31', 13, 2, 0, 'Secondary guest', '1300.00', 1, 9),
(9, '4653486987', '2023-10-30 19:15:07', '2024-05-31', 13, 2, 0, 'Secondary guest', '0.00', 1, 9),
(12, '9637938040', '2023-10-30 19:20:12', '2024-05-31', 13, 2, 0, 'Secondary guest', '0.00', 1, 9),
(15, '4443616024', '2023-10-30 19:25:55', '2024-05-31', 13, 2, 0, 'Secondary guest', '1300.00', 1, 9);
...
INSERT INTO `booking_line_item` (`booking_line_item_id`, `item_name`, `item_description`, `line_cost`, `payment_type_id`, `booking_id`) VALUES
(1, 'City Tax', 'Nightly tax cost for visiting this particular city', 15.00, 1, 2),
(2, 'Breakfast', 'Daily breakfast at accommodation', 10.00, 1, 2);
...
(8, 'Another User', 0xff36be0f8ee0617e27d588364a61f2a0da4fff4aa540df2fc456a5e2b4209c74, '2020-08-12', '2030-08-11', 'MasterCard', 9);
...
INSERT INTO `currency` (`currency_id`, `ISO_currency_code`, `currency_name`, `currency_symbol`) VALUES
...
(4, 'John', 'McGrade', 'johnsemail@gmail.com', '56565656565', '4acb74', '4acb747297d7eb55bef190e74268646b7b95fc1815b463', 1, 17),
(5, 'Kate', 'McGrade', 'katesemail@gmail.com', '78787878787', 'f6fe4e', 'f6fe4e98b7b525f4bfc3edb840c7b571d8868f76fac994', 1, 17),
(6, 'Antonio', 'Banderas', 'aband@outlook.com', '45678912301', '0f36a8', '0f36a8646fdc6c2b664310c7fe924210b0b75939cf25bc', 4, 18),
(7, 'Podraic', 'O\'Donnell', 'poddykid@hotmail.com', '96385274101', '646cf9', '646cf9d6463ce102da8ddfbbcd9bdf73880c4c6ebeee24', 2, 20),
(9, 'Another', 'User', 'fake@email.com', '00000000000', '32a108', '32a1088dc761514d069ade1fb97c71d8283e6b7f64902a', 2, 23);
...
CREATE TABLE `exchange_rate` (
  ...
  `Short_hand_description` varchar(255) NOT NULL,
  `exchange_rate` decimal(23,3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `payment_record` (
  ...
  `stripe_obj` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`stripe_obj`)),
...
INSERT INTO `payment_record` (`payment_record_id`, `stripe_obj`, `payment_card_type`, `payment_timestamp`, `customer_id`, `booking_id`) VALUES
(1, '{\n  \"id\": \"txn_1032Rp2eZvKYlo2CpErRBj09\",\n  \"object\": \"balance_transaction\",\n  \"amount\": 400,\n  \"available_on\": 1386374400,\n  \"created\": 1385853205,\n  \"currency\": \"usd\",\n  \"description\": \"Charge for test@example.com\",\n  \"exchange_rate\": null,\n  \"fee\": 42,\n  \"fee_details\": [\n    {\n      \"amount\": 42,\n      \"application\": null,\n      \"currency\": \"usd\",\n      \"description\": \"Stripe processing fees\",\n      \"type\": \"stripe_fee\"\n    }\n  ],\n  \"net\": 358,\n  \"reporting_category\": \"charge\",\n  \"source\": \"ch_1032Rp2eZvKYlo2Cv6jPGmkF\",\n  \"status\": \"available\",\n  \"type\": \"charge\"\n}', 'Visa', '2023-10-27 18:56:02', 2, 2);
...
INSERT INTO `region` (`region_id`, `region_name`, `icon_id`, `default_currency_id`) VALUES
(1, 'Ireland', 5, 3),
...
(12, 'Low Season Double', '2023-10-01', '2024-04-30', 5, '80.00', 3, 25, 2),
...
INSERT INTO `room_booking` (`room_booking_id`, `running_total`, `currency_id`, `room_id`, `booking_id`) VALUES
(4, '451.20', 1, 12, 2),
(5, '400.00', 1, 12, 3),
(6, '1300.00', 1, 13, 9),
(7, '1300.00', 1, 13, 12),
...
ALTER TABLE `exchange_rate`
  ...
  ADD KEY `FK_from_currency_room_currency_id` (`from_currency`),
  ADD KEY `FK_to_currency_booking_currency_id` (`to_currency`);
...
ALTER TABLE `payment_record`
  ...
  ADD KEY `FK_customer_customer_id_three` (`customer_id`);
...
ALTER TABLE `region`
  ...
  ADD KEY `FK_default_currency_id_currency_currency_id` (`default_currency_id`);
...
ALTER TABLE `room_image`
  ...
  ADD KEY `FK_image_image_id_two` (`image_id`);
...
--
ALTER TABLE `payment_record`
  MODIFY `payment_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `exchange_rate`
  ADD CONSTRAINT `FK_from_currency_room_currency_id` FOREIGN KEY (`from_currency`) REFERENCES `room` (`currency_id`),
  ADD CONSTRAINT `FK_to_currency_booking_currency_id` FOREIGN KEY (`to_currency`) REFERENCES `booking` (`currency_id`);
...
ALTER TABLE `payment_record`
  ...
  ADD CONSTRAINT `FK_customer_customer_id_three` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`);

--
-- Constraints for table `region`
--
ALTER TABLE `region`
  ADD CONSTRAINT `FK_default_currency_id_currency_currency_id` FOREIGN KEY (`default_currency_id`) REFERENCES `currency` (`currency_id`),
...
--
ALTER TABLE `room_image`
  ADD CONSTRAINT `FK_image_image_id_two` FOREIGN KEY (`image_id`) REFERENCES `image` (`image_id`),
